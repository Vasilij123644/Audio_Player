...
public class MusicPlayer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String img = getIntent().getStringExtra("isolnit2");
        String music = getIntent().getStringExtra("isolnit3");
        ...
        albom.setImageResource(Integer.parseInt(img.toString()));
        mPlayer= MediaPlayer.create(this, Integer.parseInt(music.toString()));
